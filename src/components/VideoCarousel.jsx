...
//         if(loadedData.length > 3) {
//             if(!isPlaying) {
//                 videoRef.current[videoId].paused();
//             }else {
//                 startPlay && videoRef.current[videoId].play();
//             }
//         }
...
//         switch (type) {
//             case 'video-end':
//                 setVideo((prev) =>({...prev, isEnd:
//                 true, videoId: i + 1}))
//                 break;
// 			case 'video-last':
// 				setVideo((prev) => ({...prev, isLastVideo:
// 				true}))
// 				break;
// 			case 'video-reset':
// 				setVideo((prev) => ({...prev, isLastVideo:
...
//             <div key={list.id} id="slider" className="sm:pr-20 pr-10">
//               <div className="video-carousel_container">
//                 <div className="w-full h-full flex flex-center overflow-hidden rounded-3xl bg-black">
//                   <video
//                     id="video"
//                     playsInline={true}
//                     preload="auto"
